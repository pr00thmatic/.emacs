...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Roboto Mono" :foundry "outline" :slant normal :weight normal :height 78 :width normal))))
...
(defun camel-case (var)
  (concat
   (downcase
    (substring var 0 1))
   (substring var 1)
   ))
(defun pascal-case (var)
  (concat
   (upcase
    (substring var 0 1))
   (substring var 1)
